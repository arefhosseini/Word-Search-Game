...
import com.fearefull.wordsearch.commons.DurationFormatter;
import com.fearefull.wordsearch.commons.Util;
import com.fearefull.wordsearch.model.GameData;
import com.fearefull.wordsearch.custom.LetterBoard;
import com.fearefull.wordsearch.custom.StreakView;
import com.fearefull.wordsearch.custom.layout.FlowLayout;
...
public class GamePlayActivity extends FullscreenActivity {
    ...
    public static final String EXTRA_GAME_ROUND_ID =
            "com.fearefull.wordsearch.features.gameplay.GamePlayActivity.ID";
